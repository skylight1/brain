 ...
 */
public class TrainBrainDrawer implements SurfaceHolder.Callback {

    private SurfaceHolder mHolder;
    private TrainBrainView mView;

    private TrainBrainView.ChangeListener mListener = new TrainBrainView.ChangeListener() {
        @Override
    ...
    public TrainBrainDrawer(Context context) {
        mView = new TrainBrainView(context);
        mView.setListener(mListener);
    }

    public Brain getBrain() {
        return mView.getBrain();
    }
